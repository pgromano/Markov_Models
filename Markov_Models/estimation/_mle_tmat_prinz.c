 ...
 */
      ...
      for (__pyx_t_12 = 0; __pyx_t_12 < __pyx_t_11; __pyx_t_12+=1) {
        ...
        /* "Markov_Models/estimation/_mle_tmat_prinz.pyx":61
 *         for i in range(nstates):
 *             for j in range(nstates):
 *                 val_a = cs[i] - C[i,j] + cs[j] - C[j,i]             # <<<<<<<<<<<<<<
 *                 val_b = cs[i]*(xs[j] - X[i,j]) + cs[j]*(xs[i] - X[i,j]) - (C[i,j] + C[j,i])*(xs[i] + xs[j] -2*X[i,j])
 ...
 */
        ...
        /* "Markov_Models/estimation/_mle_tmat_prinz.pyx":63
 *                 val_a = cs[i] - C[i,j] + cs[j] - C[j,i]
 *                 val_b = cs[i]*(xs[j] - X[i,j]) + cs[j]*(xs[i] - X[i,j]) - (C[i,j] + C[j,i])*(xs[i] + xs[j] -2*X[i,j])
 *                 val_c = -(C[i,j] + C[j,i])*(xs[i] - X[i,j])*(xs[j] - X[i,j])             # <<<<<<<<<<<<<<
 * 
 ...
 *                 if val_a == 0:
 */
          if (__Pyx_PrintOne(0, __pyx_kp_s_ERROR_Value_c_0) < 0) __PYX_ERR(0, 66, __pyx_L1_error)
 ...
 */
        ...
        /* "Markov_Models/estimation/_mle_tmat_prinz.pyx":68
 *                     print(r'ERROR! Value c > 0.')
 * 
 *                 if val_a == 0:             # <<<<<<<<<<<<<<
 *                     tmp = X[j,i]
 ...
 */
        ...
        if (__pyx_t_29) {
          ...
          /* "Markov_Models/estimation/_mle_tmat_prinz.pyx":69
 * 
 *                 if val_a == 0:
 *                     tmp = X[j,i]             # <<<<<<<<<<<<<<
 *                 else:
 ...
 */
        ...
        /* "Markov_Models/estimation/_mle_tmat_prinz.pyx":71
 *                     tmp = X[j,i]
 *                 else:
 *                     tmp = (-val_b + np.sqrt(val_b*val_b - 4*val_a*val_c)) / (2*val_a)             # <<<<<<<<<<<<<<
 * 
 ...
 */
        /*else*/ {
          __pyx_t_5 = PyFloat_FromDouble((-__pyx_v_val_b)); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 71, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_5);
          __pyx_t_1 = __Pyx_GetModuleGlobalName(__pyx_n_s_np); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 71, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_1);
          __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_sqrt); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 71, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_2);
          __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
          __pyx_t_1 = PyFloat_FromDouble(((__pyx_v_val_b * __pyx_v_val_b) - ((4.0 * __pyx_v_val_a) * __pyx_v_val_c))); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 71, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_1);
          __pyx_t_68 = NULL;
          if (CYTHON_UNPACK_METHODS && unlikely(PyMethod_Check(__pyx_t_2))) {
          ...
          if (!__pyx_t_68) {
            __pyx_t_6 = __Pyx_PyObject_CallOneArg(__pyx_t_2, __pyx_t_1); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 71, __pyx_L1_error)
            __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
            __Pyx_GOTREF(__pyx_t_6);
          } else {
            #if CYTHON_FAST_PYCALL
            if (PyFunction_Check(__pyx_t_2)) {
              ...
              __pyx_t_6 = __Pyx_PyFunction_FastCall(__pyx_t_2, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 71, __pyx_L1_error)
            ...
            if (__Pyx_PyFastCFunction_Check(__pyx_t_2)) {
              PyObject *__pyx_temp[2] = {__pyx_t_68, __pyx_t_1};
              __pyx_t_6 = __Pyx_PyCFunction_FastCall(__pyx_t_2, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 71, __pyx_L1_error)
              __Pyx_XDECREF(__pyx_t_68); __pyx_t_68 = 0;
              __Pyx_GOTREF(__pyx_t_6);
              __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
            } else
            #endif
            {
              ...
              __pyx_t_1 = 0;
              __pyx_t_6 = __Pyx_PyObject_Call(__pyx_t_2, __pyx_t_4, NULL); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 71, __pyx_L1_error)
              __Pyx_GOTREF(__pyx_t_6);
              __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
            }
          }
          __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
          __pyx_t_2 = PyNumber_Add(__pyx_t_5, __pyx_t_6); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 71, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_2);
          __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
          __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
          __pyx_t_6 = PyFloat_FromDouble((2.0 * __pyx_v_val_a)); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 71, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_6);
          __pyx_t_5 = __Pyx_PyNumber_Divide(__pyx_t_2, __pyx_t_6); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 71, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_5);
          __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
          __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
          __pyx_t_43 = __pyx_PyFloat_AsDouble(__pyx_t_5); if (unlikely((__pyx_t_43 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 71, __pyx_L1_error)
          __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
 ...
 */
        ...
        *((double *) ( /* dim=0 */ (__pyx_v_xs.data + __pyx_t_106 * __pyx_v_xs.strides[0]) )) = ((*((double *) ( /* dim=0 */ (__pyx_v_xs.data + __pyx_t_103 * __pyx_v_xs.strides[0]) ))) + (__pyx_v_tmp - (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_X.data + __pyx_t_104 * __pyx_v_X.strides[0]) ) + __pyx_t_105 * __pyx_v_X.strides[1]) )))));
        ...
        /* "Markov_Models/estimation/_mle_tmat_prinz.pyx":74
 * 
 *                 xs[i] = xs[i] + (tmp - X[i,j])
 *                 xs[j] = xs[j] + (tmp - X[j,i])             # <<<<<<<<<<<<<<
 * 
 ...
 */
        ...
        *((double *) ( /* dim=0 */ (__pyx_v_xs.data + __pyx_t_115 * __pyx_v_xs.strides[0]) )) = 0.0;
        ...
        /* "Markov_Models/estimation/_mle_tmat_prinz.pyx":79
 * 
 *                 xs[i] = 0
 *                 for k in range(nstates):             # <<<<<<<<<<<<<<
 *                     xs[i] = xs[i] + X[i,k]
 ...
 */
        ...
        /* "Markov_Models/estimation/_mle_tmat_prinz.pyx":82
 *                     xs[i] = xs[i] + X[i,k]
 * 
 *                 xs[j] = 0             # <<<<<<<<<<<<<<
 *                 for k in range(nstates):
 ...
 */
        ...
        for (__pyx_t_117 = 0; __pyx_t_117 < __pyx_t_116; __pyx_t_117+=1) {
          ...
          /* "Markov_Models/estimation/_mle_tmat_prinz.pyx":84
 *                 xs[j] = 0
 *                 for k in range(nstates):
 *                     xs[j] = xs[j] + X[j,k]             # <<<<<<<<<<<<<<
 * 
 ...
 *     for i in range(nstates):
 */
          __pyx_t_5 = PyFloat_FromDouble(__pyx_v_liklihood); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 87, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_5);
          __pyx_t_129 = __pyx_v_i;
          __pyx_t_130 = __pyx_v_j;
          __pyx_t_6 = PyFloat_FromDouble((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_C.data + __pyx_t_129 * __pyx_v_C.strides[0]) ) + __pyx_t_130 * __pyx_v_C.strides[1]) )))); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 87, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_6);
          __pyx_t_4 = __Pyx_GetModuleGlobalName(__pyx_n_s_np); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 87, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_4);
          __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_log); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 87, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_1);
          __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
          ...
          __pyx_t_4 = PyFloat_FromDouble((__pyx_t_43 / __pyx_t_47)); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 87, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_4);
          __pyx_t_68 = NULL;
          ...
          __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
          __pyx_t_1 = PyNumber_Multiply(__pyx_t_6, __pyx_t_2); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 87, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_1);
          __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
          __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
          __pyx_t_2 = PyNumber_Add(__pyx_t_5, __pyx_t_1); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 87, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_2);
          __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
          __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
          __pyx_t_134 = __pyx_v_j;
          __pyx_t_135 = __pyx_v_i;
          __pyx_t_1 = PyFloat_FromDouble((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_C.data + __pyx_t_134 * __pyx_v_C.strides[0]) ) + __pyx_t_135 * __pyx_v_C.strides[1]) )))); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 87, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_1);
          __pyx_t_6 = __Pyx_GetModuleGlobalName(__pyx_n_s_np); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 87, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_6);
          __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_6, __pyx_n_s_log); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 87, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_3);
          __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
          ...
          __pyx_t_6 = PyFloat_FromDouble((__pyx_t_47 / __pyx_t_43)); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 87, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_6);
          __pyx_t_4 = NULL;
          if (CYTHON_UNPACK_METHODS && unlikely(PyMethod_Check(__pyx_t_3))) {
            __pyx_t_4 = PyMethod_GET_SELF(__pyx_t_3);
          ...
          if (!__pyx_t_4) {
            __pyx_t_5 = __Pyx_PyObject_CallOneArg(__pyx_t_3, __pyx_t_6); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 87, __pyx_L1_error)
            __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
            __Pyx_GOTREF(__pyx_t_5);
          } else {
            #if CYTHON_FAST_PYCALL
            if (PyFunction_Check(__pyx_t_3)) {
              PyObject *__pyx_temp[2] = {__pyx_t_4, __pyx_t_6};
              __pyx_t_5 = __Pyx_PyFunction_FastCall(__pyx_t_3, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 87, __pyx_L1_error)
              __Pyx_XDECREF(__pyx_t_4); __pyx_t_4 = 0;
              __Pyx_GOTREF(__pyx_t_5);
              __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
            } else
            ...
            if (__Pyx_PyFastCFunction_Check(__pyx_t_3)) {
              PyObject *__pyx_temp[2] = {__pyx_t_4, __pyx_t_6};
              __pyx_t_5 = __Pyx_PyCFunction_FastCall(__pyx_t_3, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 87, __pyx_L1_error)
              __Pyx_XDECREF(__pyx_t_4); __pyx_t_4 = 0;
              __Pyx_GOTREF(__pyx_t_5);
              __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
            } else
            #endif
            {
              __pyx_t_68 = PyTuple_New(1+1); if (unlikely(!__pyx_t_68)) __PYX_ERR(0, 87, __pyx_L1_error)
              __Pyx_GOTREF(__pyx_t_68);
              __Pyx_GIVEREF(__pyx_t_4); PyTuple_SET_ITEM(__pyx_t_68, 0, __pyx_t_4); __pyx_t_4 = NULL;
              __Pyx_GIVEREF(__pyx_t_6);
              PyTuple_SET_ITEM(__pyx_t_68, 0+1, __pyx_t_6);
              __pyx_t_6 = 0;
              __pyx_t_5 = __Pyx_PyObject_Call(__pyx_t_3, __pyx_t_68, NULL); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 87, __pyx_L1_error)
              __Pyx_GOTREF(__pyx_t_5);
              __Pyx_DECREF(__pyx_t_68); __pyx_t_68 = 0;
            }
          }
          __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
          __pyx_t_3 = PyNumber_Multiply(__pyx_t_1, __pyx_t_5); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 87, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_3);
          __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
          __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
          __pyx_t_5 = PyNumber_Add(__pyx_t_2, __pyx_t_3); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 87, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_5);
          __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
          __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
          __pyx_t_43 = __pyx_PyFloat_AsDouble(__pyx_t_5); if (unlikely((__pyx_t_43 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 87, __pyx_L1_error)
          __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
          __pyx_v_liklihood = __pyx_t_43;
 ...
 */
  ...
  __pyx_t_5 = __pyx_memoryview_fromslice(__pyx_v_T, 2, (PyObject *(*)(char *)) __pyx_memview_get_double, (int (*)(char *, PyObject *)) __pyx_memview_set_double, 0);; if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 93, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_r = __pyx_t_5;
  __pyx_t_5 = 0;
  goto __pyx_L0;
