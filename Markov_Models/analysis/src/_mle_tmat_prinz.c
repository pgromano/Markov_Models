...
/* BEGIN: Cython Metadata
{
    ...
    "module_name": "Markov_Models.analysis.src._mle_tmat_prinz"
}
END: Cython Metadata */
...
#define __PYX_HAVE__Markov_Models__analysis__src___mle_tmat_prinz
#define __PYX_HAVE_API__Markov_Models__analysis__src___mle_tmat_prinz
#include <string.h>
#include <stdio.h>
#include <stdlib.h>
...
static const char *__pyx_f[] = {
  "Markov_Models/analysis/src/_mle_tmat_prinz.pyx",
  "__init__.pxd",
  "stringsource",
  "type.pxd",
};
...
/* Module declarations from 'Markov_Models.analysis.src._mle_tmat_prinz' */
...
#define __Pyx_MODULE_NAME "Markov_Models.analysis.src._mle_tmat_prinz"
int __pyx_module_is_main_Markov_Models__analysis__src___mle_tmat_prinz = 0;

/* Implementation of 'Markov_Models.analysis.src._mle_tmat_prinz' */
...
static const char __pyx_k_Markov_Models_analysis_src__mle[] = "Markov_Models.analysis.src._mle_tmat_prinz";
static const char __pyx_k_Method_failed_to_converge_after[] = "Method failed to converge after ";
static const char __pyx_k_Users_pablo_Programs_Markov_Mod[] = "/Users/pablo/Programs/Markov_Models/Markov_Models/analysis/src/_mle_tmat_prinz.pyx";
...
static PyObject *__pyx_n_s_Markov_Models_analysis_src__mle;
...
static PyObject *__pyx_kp_s_Users_pablo_Programs_Markov_Mod;
...
static PyObject *__pyx_pf_13Markov_Models_8analysis_3src_15_mle_tmat_prinz_transition_matrix(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_C, PyObject *__pyx_v_tol, PyObject *__pyx_v_max_iteration); /* proto */
...
/* "Markov_Models/analysis/src/_mle_tmat_prinz.pyx":8
...
/* Python wrapper */
static PyObject *__pyx_pw_13Markov_Models_8analysis_3src_15_mle_tmat_prinz_1transition_matrix(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_13Markov_Models_8analysis_3src_15_mle_tmat_prinz_1transition_matrix = {"transition_matrix", (PyCFunction)__pyx_pw_13Markov_Models_8analysis_3src_15_mle_tmat_prinz_1transition_matrix, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_13Markov_Models_8analysis_3src_15_mle_tmat_prinz_1transition_matrix(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("Markov_Models.analysis.src._mle_tmat_prinz.transition_matrix", __pyx_clineno, __pyx_lineno, __pyx_filename);
  ...
  __pyx_r = __pyx_pf_13Markov_Models_8analysis_3src_15_mle_tmat_prinz_transition_matrix(__pyx_self, __pyx_v_C, __pyx_v_tol, __pyx_v_max_iteration);
...
static PyObject *__pyx_pf_13Markov_Models_8analysis_3src_15_mle_tmat_prinz_transition_matrix(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_C, PyObject *__pyx_v_tol, PyObject *__pyx_v_max_iteration) {
  ...
  /* "Markov_Models/analysis/src/_mle_tmat_prinz.pyx":9
 * @cython.wraparound(False)
 * def transition_matrix(double[:,:] C, np.float tol, np.int max_iteration):
 *     cdef long nstates = C.shape[0]             # <<<<<<<<<<<<<<
 *     cdef double[:,:] T = np.zeros((nstates, nstates)).astype(np.float64)
 ...
 */
  ...
  /* "Markov_Models/analysis/src/_mle_tmat_prinz.pyx":10
 * def transition_matrix(double[:,:] C, np.float tol, np.int max_iteration):
 *     cdef long nstates = C.shape[0]
 *     cdef double[:,:] T = np.zeros((nstates, nstates)).astype(np.float64)             # <<<<<<<<<<<<<<
 *     cdef double[:,:] X = np.zeros((nstates, nstates)).astype(np.float64)
 ...
 */
  ...
  /* "Markov_Models/analysis/src/_mle_tmat_prinz.pyx":11
 *     cdef long nstates = C.shape[0]
 *     cdef double[:,:] T = np.zeros((nstates, nstates)).astype(np.float64)
 *     cdef double[:,:] X = np.zeros((nstates, nstates)).astype(np.float64)             # <<<<<<<<<<<<<<
 *     cdef double[:] xs = np.zeros(nstates).astype(np.float64)
 ...
 */
  ...
  /* "Markov_Models/analysis/src/_mle_tmat_prinz.pyx":12
 *     cdef double[:,:] T = np.zeros((nstates, nstates)).astype(np.float64)
 *     cdef double[:,:] X = np.zeros((nstates, nstates)).astype(np.float64)
 *     cdef double[:] xs = np.zeros(nstates).astype(np.float64)             # <<<<<<<<<<<<<<
 *     cdef double[:] cs = np.zeros(nstates).astype(np.float64)
 ...
 */
  ...
  /* "Markov_Models/analysis/src/_mle_tmat_prinz.pyx":13
 *     cdef double[:,:] X = np.zeros((nstates, nstates)).astype(np.float64)
 *     cdef double[:] xs = np.zeros(nstates).astype(np.float64)
 *     cdef double[:] cs = np.zeros(nstates).astype(np.float64)             # <<<<<<<<<<<<<<
 *     cdef double liklihood = 0
 ...
 */
  ...
  /* "Markov_Models/analysis/src/_mle_tmat_prinz.pyx":14
 *     cdef double[:] xs = np.zeros(nstates).astype(np.float64)
 *     cdef double[:] cs = np.zeros(nstates).astype(np.float64)
 *     cdef double liklihood = 0             # <<<<<<<<<<<<<<
 *     cdef double liklihood_prev = 1e6
 ...
 */
  ...
  /* "Markov_Models/analysis/src/_mle_tmat_prinz.pyx":15
 *     cdef double[:] cs = np.zeros(nstates).astype(np.float64)
 *     cdef double liklihood = 0
 *     cdef double liklihood_prev = 1e6             # <<<<<<<<<<<<<<
 *     cdef int i, j, k, iteration
 ...
 */
  ...
  /* "Markov_Models/analysis/src/_mle_tmat_prinz.pyx":20
 * 
 ...
 */
  ...
  for (__pyx_t_10 = 0; __pyx_t_10 < __pyx_t_9; __pyx_t_10+=1) {
    ...
    /* "Markov_Models/analysis/src/_mle_tmat_prinz.pyx":21
 *     # Uncondintional transition matrix $X_{i,j} = \pi_i T_{i,j}$
 *     for i in range(nstates):
 *         for j in range(nstates):             # <<<<<<<<<<<<<<
 *             X[i,j] = C[i,j] + C[j,i]
 ...
 */
    ...
    for (__pyx_t_12 = 0; __pyx_t_12 < __pyx_t_11; __pyx_t_12+=1) {
      ...
      /* "Markov_Models/analysis/src/_mle_tmat_prinz.pyx":22
 *     for i in range(nstates):
 *         for j in range(nstates):
 *             X[i,j] = C[i,j] + C[j,i]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "Markov_Models/analysis/src/_mle_tmat_prinz.pyx":24
 *             X[i,j] = C[i,j] + C[j,i]
 * 
 *     for i in range(nstates):             # <<<<<<<<<<<<<<
 *         xs[i] = 0
 ...
 */
  ...
  for (__pyx_t_10 = 0; __pyx_t_10 < __pyx_t_9; __pyx_t_10+=1) {
    ...
    /* "Markov_Models/analysis/src/_mle_tmat_prinz.pyx":25
 * 
 *     for i in range(nstates):
 *         xs[i] = 0             # <<<<<<<<<<<<<<
 *         cs[i] = 0
 ...
 */
    ...
    *((double *) ( /* dim=0 */ (__pyx_v_xs.data + __pyx_t_19 * __pyx_v_xs.strides[0]) )) = 0.0;
    ...
    /* "Markov_Models/analysis/src/_mle_tmat_prinz.pyx":26
 *     for i in range(nstates):
 *         xs[i] = 0
 *         cs[i] = 0             # <<<<<<<<<<<<<<
 *         for j in range(nstates):
 ...
 */
    ...
    *((double *) ( /* dim=0 */ (__pyx_v_cs.data + __pyx_t_20 * __pyx_v_cs.strides[0]) )) = 0.0;
    ...
    /* "Markov_Models/analysis/src/_mle_tmat_prinz.pyx":27
 *         xs[i] = 0
 *         cs[i] = 0
 *         for j in range(nstates):             # <<<<<<<<<<<<<<
 *             xs[i] = xs[i] + X[i,j]
 ...
 */
    ...
    for (__pyx_t_12 = 0; __pyx_t_12 < __pyx_t_11; __pyx_t_12+=1) {
      ...
      /* "Markov_Models/analysis/src/_mle_tmat_prinz.pyx":28
 *         cs[i] = 0
 *         for j in range(nstates):
 *             xs[i] = xs[i] + X[i,j]             # <<<<<<<<<<<<<<
 *             cs[i] = cs[i] + C[i,j]
 ...
 */
      ...
      *((double *) ( /* dim=0 */ (__pyx_v_xs.data + __pyx_t_24 * __pyx_v_xs.strides[0]) )) = ((*((double *) ( /* dim=0 */ (__pyx_v_xs.data + __pyx_t_21 * __pyx_v_xs.strides[0]) ))) + (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_X.data + __pyx_t_22 * __pyx_v_X.strides[0]) ) + __pyx_t_23 * __pyx_v_X.strides[1]) ))));
      ...
      /* "Markov_Models/analysis/src/_mle_tmat_prinz.pyx":29
 *         for j in range(nstates):
 *             xs[i] = xs[i] + X[i,j]
 *             cs[i] = cs[i] + C[i,j]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "Markov_Models/analysis/src/_mle_tmat_prinz.pyx":31
 *             cs[i] = cs[i] + C[i,j]
 * 
 *     iteration = 0             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "Markov_Models/analysis/src/_mle_tmat_prinz.pyx":32
 * 
 *     iteration = 0
 *     while abs(liklihood-liklihood_prev) >= tol:             # <<<<<<<<<<<<<<
 *         liklihood_prev = liklihood
 ...
 */
  while (1) {
    __pyx_t_1 = PyFloat_FromDouble(fabs((__pyx_v_liklihood - __pyx_v_liklihood_prev))); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 32, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_2 = PyObject_RichCompare(__pyx_t_1, __pyx_v_tol, Py_GE); __Pyx_XGOTREF(__pyx_t_2); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 32, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __pyx_t_29 = __Pyx_PyObject_IsTrue(__pyx_t_2); if (unlikely(__pyx_t_29 < 0)) __PYX_ERR(0, 32, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    if (!__pyx_t_29) break;

    /* "Markov_Models/analysis/src/_mle_tmat_prinz.pyx":33
 *     iteration = 0
 *     while abs(liklihood-liklihood_prev) >= tol:
 *         liklihood_prev = liklihood             # <<<<<<<<<<<<<<
 *         liklihood = 0
 ...
 */
    ...
    /* "Markov_Models/analysis/src/_mle_tmat_prinz.pyx":34
 *     while abs(liklihood-liklihood_prev) >= tol:
 *         liklihood_prev = liklihood
 *         liklihood = 0             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "Markov_Models/analysis/src/_mle_tmat_prinz.pyx":36
 *         liklihood = 0
 * 
 *         iteration += 1             # <<<<<<<<<<<<<<
 ...
 */
    ...
    /* "Markov_Models/analysis/src/_mle_tmat_prinz.pyx":37
 * 
 *         iteration += 1
 *         if iteration > max_iteration:             # <<<<<<<<<<<<<<
 *             print('Method failed to converge after '+str(max_iteration)+' iterations. Try either increasing tolerance or increasing maximum number of iterations.')
 *             break
 */
    __pyx_t_2 = __Pyx_PyInt_From_int(__pyx_v_iteration); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 37, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_t_1 = PyObject_RichCompare(__pyx_t_2, __pyx_v_max_iteration, Py_GT); __Pyx_XGOTREF(__pyx_t_1); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 37, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    __pyx_t_29 = __Pyx_PyObject_IsTrue(__pyx_t_1); if (unlikely(__pyx_t_29 < 0)) __PYX_ERR(0, 37, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    if (__pyx_t_29) {

      /* "Markov_Models/analysis/src/_mle_tmat_prinz.pyx":38
 *         iteration += 1
 *         if iteration > max_iteration:
 *             print('Method failed to converge after '+str(max_iteration)+' iterations. Try either increasing tolerance or increasing maximum number of iterations.')             # <<<<<<<<<<<<<<
 *             break
 ...
 */
      ...
      __pyx_t_2 = __Pyx_PyObject_Call(((PyObject *)(&PyString_Type)), __pyx_t_1, NULL); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 38, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_2);
      __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
      __pyx_t_1 = PyNumber_Add(__pyx_kp_s_Method_failed_to_converge_after, __pyx_t_2); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 38, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_1);
      __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
      __pyx_t_2 = PyNumber_Add(__pyx_t_1, __pyx_kp_s_iterations_Try_either_increasin); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 38, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_2);
      __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
      if (__Pyx_PrintOne(0, __pyx_t_2) < 0) __PYX_ERR(0, 38, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

      /* "Markov_Models/analysis/src/_mle_tmat_prinz.pyx":39
 *         if iteration > max_iteration:
 *             print('Method failed to converge after '+str(max_iteration)+' iterations. Try either increasing tolerance or increasing maximum number of iterations.')
 *             break             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "Markov_Models/analysis/src/_mle_tmat_prinz.pyx":41
 *             break
 * 
 *         for i in range(nstates):             # <<<<<<<<<<<<<<
 *             tmp = X[i,i]
 ...
 */
    ...
    for (__pyx_t_10 = 0; __pyx_t_10 < __pyx_t_9; __pyx_t_10+=1) {
      ...
      /* "Markov_Models/analysis/src/_mle_tmat_prinz.pyx":42
 * 
 *         for i in range(nstates):
 *             tmp = X[i,i]             # <<<<<<<<<<<<<<
 *             if cs[i] - C[i,i] > 0:
 ...
 */
      ...
      __pyx_v_tmp = (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_X.data + __pyx_t_30 * __pyx_v_X.strides[0]) ) + __pyx_t_31 * __pyx_v_X.strides[1]) )));

      /* "Markov_Models/analysis/src/_mle_tmat_prinz.pyx":43
 *         for i in range(nstates):
 *             tmp = X[i,i]
 *             if cs[i] - C[i,i] > 0:             # <<<<<<<<<<<<<<
 *                 X[i,i] = C[i,i]*(xs[i] - X[i,i]) / (cs[i] - C[i,i])
 ...
 */
      ...
      __pyx_t_29 = ((((*((double *) ( /* dim=0 */ (__pyx_v_cs.data + __pyx_t_32 * __pyx_v_cs.strides[0]) ))) - (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_C.data + __pyx_t_33 * __pyx_v_C.strides[0]) ) + __pyx_t_34 * __pyx_v_C.strides[1]) )))) > 0.0) != 0);
      if (__pyx_t_29) {

        /* "Markov_Models/analysis/src/_mle_tmat_prinz.pyx":44
 *             tmp = X[i,i]
 *             if cs[i] - C[i,i] > 0:
 *                 X[i,i] = C[i,i]*(xs[i] - X[i,i]) / (cs[i] - C[i,i])             # <<<<<<<<<<<<<<
 *             xs[i] = xs[i] + (X[i,i] - tmp)
 ...
 */
        ...
        __pyx_t_40 = ((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_C.data + __pyx_t_35 * __pyx_v_C.strides[0]) ) + __pyx_t_36 * __pyx_v_C.strides[1]) ))) * ((*((double *) ( /* dim=0 */ (__pyx_v_xs.data + __pyx_t_37 * __pyx_v_xs.strides[0]) ))) - (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_X.data + __pyx_t_38 * __pyx_v_X.strides[0]) ) + __pyx_t_39 * __pyx_v_X.strides[1]) )))));
        __pyx_t_41 = __pyx_v_i;
        __pyx_t_42 = __pyx_v_i;
        __pyx_t_43 = __pyx_v_i;
        __pyx_t_44 = ((*((double *) ( /* dim=0 */ (__pyx_v_cs.data + __pyx_t_41 * __pyx_v_cs.strides[0]) ))) - (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_C.data + __pyx_t_42 * __pyx_v_C.strides[0]) ) + __pyx_t_43 * __pyx_v_C.strides[1]) ))));
        ...
        *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_X.data + __pyx_t_45 * __pyx_v_X.strides[0]) ) + __pyx_t_46 * __pyx_v_X.strides[1]) )) = (__pyx_t_40 / __pyx_t_44);
 ...
 */
      ...
      /* "Markov_Models/analysis/src/_mle_tmat_prinz.pyx":45
 *             if cs[i] - C[i,i] > 0:
 *                 X[i,i] = C[i,i]*(xs[i] - X[i,i]) / (cs[i] - C[i,i])
 *             xs[i] = xs[i] + (X[i,i] - tmp)             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      *((double *) ( /* dim=0 */ (__pyx_v_xs.data + __pyx_t_50 * __pyx_v_xs.strides[0]) )) = ((*((double *) ( /* dim=0 */ (__pyx_v_xs.data + __pyx_t_47 * __pyx_v_xs.strides[0]) ))) + ((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_X.data + __pyx_t_48 * __pyx_v_X.strides[0]) ) + __pyx_t_49 * __pyx_v_X.strides[1]) ))) - __pyx_v_tmp));

      /* "Markov_Models/analysis/src/_mle_tmat_prinz.pyx":47
 *             xs[i] = xs[i] + (X[i,i] - tmp)
 * 
 *             xs[i] = 0             # <<<<<<<<<<<<<<
 *             for j in range(nstates):
 ...
 */
      ...
      *((double *) ( /* dim=0 */ (__pyx_v_xs.data + __pyx_t_51 * __pyx_v_xs.strides[0]) )) = 0.0;

      /* "Markov_Models/analysis/src/_mle_tmat_prinz.pyx":48
 * 
 *             xs[i] = 0
 *             for j in range(nstates):             # <<<<<<<<<<<<<<
 *                 xs[i] = xs[i] + X[i,j]
 ...
 */
      ...
      for (__pyx_t_12 = 0; __pyx_t_12 < __pyx_t_11; __pyx_t_12+=1) {
        ...
        /* "Markov_Models/analysis/src/_mle_tmat_prinz.pyx":49
 *             xs[i] = 0
 *             for j in range(nstates):
 *                 xs[i] = xs[i] + X[i,j]             # <<<<<<<<<<<<<<
 *             if xs[i] < 0:
 ...
 */
        ...
        *((double *) ( /* dim=0 */ (__pyx_v_xs.data + __pyx_t_55 * __pyx_v_xs.strides[0]) )) = ((*((double *) ( /* dim=0 */ (__pyx_v_xs.data + __pyx_t_52 * __pyx_v_xs.strides[0]) ))) + (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_X.data + __pyx_t_53 * __pyx_v_X.strides[0]) ) + __pyx_t_54 * __pyx_v_X.strides[1]) ))));
      }

      /* "Markov_Models/analysis/src/_mle_tmat_prinz.pyx":50
 *             for j in range(nstates):
 *                 xs[i] = xs[i] + X[i,j]
 *             if xs[i] < 0:             # <<<<<<<<<<<<<<
 *                 print('ERROR! x.sum(1) = '+str(xs[i]))
 ...
 */
      ...
      __pyx_t_29 = (((*((double *) ( /* dim=0 */ (__pyx_v_xs.data + __pyx_t_56 * __pyx_v_xs.strides[0]) ))) < 0.0) != 0);
      if (__pyx_t_29) {

        /* "Markov_Models/analysis/src/_mle_tmat_prinz.pyx":51
 *                 xs[i] = xs[i] + X[i,j]
 *             if xs[i] < 0:
 *                 print('ERROR! x.sum(1) = '+str(xs[i]))             # <<<<<<<<<<<<<<
 * 
 ...
 */
        ...
        __pyx_t_2 = PyFloat_FromDouble((*((double *) ( /* dim=0 */ (__pyx_v_xs.data + __pyx_t_57 * __pyx_v_xs.strides[0]) )))); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 51, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_2);
        ...
        __Pyx_GOTREF(__pyx_t_2);
        __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
        __pyx_t_1 = PyNumber_Add(__pyx_kp_s_ERROR_x_sum_1, __pyx_t_2); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 51, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_1);
        __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 */
      ...
      /* "Markov_Models/analysis/src/_mle_tmat_prinz.pyx":53
 *                 print('ERROR! x.sum(1) = '+str(xs[i]))
 * 
 *             if X[i,i] > 0:             # <<<<<<<<<<<<<<
 ...
 */
      ...
      __pyx_t_29 = (((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_X.data + __pyx_t_58 * __pyx_v_X.strides[0]) ) + __pyx_t_59 * __pyx_v_X.strides[1]) ))) > 0.0) != 0);
      if (__pyx_t_29) {

        /* "Markov_Models/analysis/src/_mle_tmat_prinz.pyx":54
 * 
 *             if X[i,i] > 0:
 *                 liklihood = liklihood + C[i,i]*np.log(X[i,i]/xs[i])             # <<<<<<<<<<<<<<
 * 
 *         for i in range(nstates):
 */
        __pyx_t_1 = PyFloat_FromDouble(__pyx_v_liklihood); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 54, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_1);
        __pyx_t_60 = __pyx_v_i;
        __pyx_t_61 = __pyx_v_i;
        __pyx_t_2 = PyFloat_FromDouble((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_C.data + __pyx_t_60 * __pyx_v_C.strides[0]) ) + __pyx_t_61 * __pyx_v_C.strides[1]) )))); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 54, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_2);
        __pyx_t_4 = __Pyx_GetModuleGlobalName(__pyx_n_s_np); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 54, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_4);
        __pyx_t_6 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_log); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 54, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_6);
        __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
        __pyx_t_62 = __pyx_v_i;
        __pyx_t_63 = __pyx_v_i;
        __pyx_t_44 = (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_X.data + __pyx_t_62 * __pyx_v_X.strides[0]) ) + __pyx_t_63 * __pyx_v_X.strides[1]) )));
        __pyx_t_64 = __pyx_v_i;
        __pyx_t_40 = (*((double *) ( /* dim=0 */ (__pyx_v_xs.data + __pyx_t_64 * __pyx_v_xs.strides[0]) )));
        if (unlikely(__pyx_t_40 == 0)) {
          PyErr_SetString(PyExc_ZeroDivisionError, "float division");
          __PYX_ERR(0, 54, __pyx_L1_error)
        }
        __pyx_t_4 = PyFloat_FromDouble((__pyx_t_44 / __pyx_t_40)); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 54, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_4);
        __pyx_t_3 = NULL;
        if (CYTHON_UNPACK_METHODS && unlikely(PyMethod_Check(__pyx_t_6))) {
          __pyx_t_3 = PyMethod_GET_SELF(__pyx_t_6);
        ...
        if (!__pyx_t_3) {
          __pyx_t_5 = __Pyx_PyObject_CallOneArg(__pyx_t_6, __pyx_t_4); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 54, __pyx_L1_error)
          __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
          __Pyx_GOTREF(__pyx_t_5);
        } else {
          #if CYTHON_FAST_PYCALL
          ...
          #endif
          {
            __pyx_t_65 = PyTuple_New(1+1); if (unlikely(!__pyx_t_65)) __PYX_ERR(0, 54, __pyx_L1_error)
            __Pyx_GOTREF(__pyx_t_65);
            __Pyx_GIVEREF(__pyx_t_3); PyTuple_SET_ITEM(__pyx_t_65, 0, __pyx_t_3); __pyx_t_3 = NULL;
            __Pyx_GIVEREF(__pyx_t_4);
            PyTuple_SET_ITEM(__pyx_t_65, 0+1, __pyx_t_4);
            __pyx_t_4 = 0;
            __pyx_t_5 = __Pyx_PyObject_Call(__pyx_t_6, __pyx_t_65, NULL); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 54, __pyx_L1_error)
            __Pyx_GOTREF(__pyx_t_5);
            __Pyx_DECREF(__pyx_t_65); __pyx_t_65 = 0;
          }
        }
        __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
        __pyx_t_6 = PyNumber_Multiply(__pyx_t_2, __pyx_t_5); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 54, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_6);
        __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
        __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
        __pyx_t_5 = PyNumber_Add(__pyx_t_1, __pyx_t_6); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 54, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_5);
        __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
        __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
        __pyx_t_40 = __pyx_PyFloat_AsDouble(__pyx_t_5); if (unlikely((__pyx_t_40 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 54, __pyx_L1_error)
        __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
        __pyx_v_liklihood = __pyx_t_40;
 ...
 */
    ...
    /* "Markov_Models/analysis/src/_mle_tmat_prinz.pyx":56
 *                 liklihood = liklihood + C[i,i]*np.log(X[i,i]/xs[i])
 * 
 *         for i in range(nstates):             # <<<<<<<<<<<<<<
 *             for j in range(nstates):
 ...
 */
    ...
    for (__pyx_t_10 = 0; __pyx_t_10 < __pyx_t_9; __pyx_t_10+=1) {
      ...
      /* "Markov_Models/analysis/src/_mle_tmat_prinz.pyx":57
 * 
 *         for i in range(nstates):
 *             for j in range(nstates):             # <<<<<<<<<<<<<<
 *                 val_a = cs[i] - C[i,j] + cs[j] - C[j,i]
 ...
 */
      ...
      for (__pyx_t_12 = 0; __pyx_t_12 < __pyx_t_11; __pyx_t_12+=1) {
        ...
        /* "Markov_Models/analysis/src/_mle_tmat_prinz.pyx":58
 *         for i in range(nstates):
 *             for j in range(nstates):
 *                 val_a = cs[i] - C[i,j] + cs[j] - C[j,i]             # <<<<<<<<<<<<<<
 *                 val_b = cs[i]*(xs[j] - X[i,j]) + cs[j]*(xs[i] - X[i,j]) - (C[i,j] + C[j,i])*(xs[i] + xs[j] -2*X[i,j])
 ...
 */
        ...
        __pyx_v_val_a = ((((*((double *) ( /* dim=0 */ (__pyx_v_cs.data + __pyx_t_66 * __pyx_v_cs.strides[0]) ))) - (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_C.data + __pyx_t_67 * __pyx_v_C.strides[0]) ) + __pyx_t_68 * __pyx_v_C.strides[1]) )))) + (*((double *) ( /* dim=0 */ (__pyx_v_cs.data + __pyx_t_69 * __pyx_v_cs.strides[0]) )))) - (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_C.data + __pyx_t_70 * __pyx_v_C.strides[0]) ) + __pyx_t_71 * __pyx_v_C.strides[1]) ))));

        /* "Markov_Models/analysis/src/_mle_tmat_prinz.pyx":59
 *             for j in range(nstates):
 *                 val_a = cs[i] - C[i,j] + cs[j] - C[j,i]
 *                 val_b = cs[i]*(xs[j] - X[i,j]) + cs[j]*(xs[i] - X[i,j]) - (C[i,j] + C[j,i])*(xs[i] + xs[j] -2*X[i,j])             # <<<<<<<<<<<<<<
 *                 val_c = -(C[i,j] + C[j,i])*(xs[i] - X[i,j])*(xs[j] - X[i,j])
 ...
 */
        ...
        __pyx_v_val_b = ((((*((double *) ( /* dim=0 */ (__pyx_v_cs.data + __pyx_t_72 * __pyx_v_cs.strides[0]) ))) * ((*((double *) ( /* dim=0 */ (__pyx_v_xs.data + __pyx_t_73 * __pyx_v_xs.strides[0]) ))) - (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_X.data + __pyx_t_74 * __pyx_v_X.strides[0]) ) + __pyx_t_75 * __pyx_v_X.strides[1]) ))))) + ((*((double *) ( /* dim=0 */ (__pyx_v_cs.data + __pyx_t_76 * __pyx_v_cs.strides[0]) ))) * ((*((double *) ( /* dim=0 */ (__pyx_v_xs.data + __pyx_t_77 * __pyx_v_xs.strides[0]) ))) - (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_X.data + __pyx_t_78 * __pyx_v_X.strides[0]) ) + __pyx_t_79 * __pyx_v_X.strides[1]) )))))) - (((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_C.data + __pyx_t_80 * __pyx_v_C.strides[0]) ) + __pyx_t_81 * __pyx_v_C.strides[1]) ))) + (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_C.data + __pyx_t_82 * __pyx_v_C.strides[0]) ) + __pyx_t_83 * __pyx_v_C.strides[1]) )))) * (((*((double *) ( /* dim=0 */ (__pyx_v_xs.data + __pyx_t_84 * __pyx_v_xs.strides[0]) ))) + (*((double *) ( /* dim=0 */ (__pyx_v_xs.data + __pyx_t_85 * __pyx_v_xs.strides[0]) )))) - (2.0 * (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_X.data + __pyx_t_86 * __pyx_v_X.strides[0]) ) + __pyx_t_87 * __pyx_v_X.strides[1]) )))))));

        /* "Markov_Models/analysis/src/_mle_tmat_prinz.pyx":60
 *                 val_a = cs[i] - C[i,j] + cs[j] - C[j,i]
 *                 val_b = cs[i]*(xs[j] - X[i,j]) + cs[j]*(xs[i] - X[i,j]) - (C[i,j] + C[j,i])*(xs[i] + xs[j] -2*X[i,j])
 *                 val_c = -(C[i,j] + C[j,i])*(xs[i] - X[i,j])*(xs[j] - X[i,j])             # <<<<<<<<<<<<<<
 * 
 ...
 */
        ...
        __pyx_v_val_c = (((-((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_C.data + __pyx_t_88 * __pyx_v_C.strides[0]) ) + __pyx_t_89 * __pyx_v_C.strides[1]) ))) + (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_C.data + __pyx_t_90 * __pyx_v_C.strides[0]) ) + __pyx_t_91 * __pyx_v_C.strides[1]) ))))) * ((*((double *) ( /* dim=0 */ (__pyx_v_xs.data + __pyx_t_92 * __pyx_v_xs.strides[0]) ))) - (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_X.data + __pyx_t_93 * __pyx_v_X.strides[0]) ) + __pyx_t_94 * __pyx_v_X.strides[1]) ))))) * ((*((double *) ( /* dim=0 */ (__pyx_v_xs.data + __pyx_t_95 * __pyx_v_xs.strides[0]) ))) - (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_X.data + __pyx_t_96 * __pyx_v_X.strides[0]) ) + __pyx_t_97 * __pyx_v_X.strides[1]) )))));

        /* "Markov_Models/analysis/src/_mle_tmat_prinz.pyx":62
 *                 val_c = -(C[i,j] + C[j,i])*(xs[i] - X[i,j])*(xs[j] - X[i,j])
 * 
 *                 if val_c > 0:             # <<<<<<<<<<<<<<
 ...
 */
        ...
        if (__pyx_t_29) {
          ...
          /* "Markov_Models/analysis/src/_mle_tmat_prinz.pyx":63
 * 
 *                 if val_c > 0:
 *                     print(r'ERROR! Value c > 0.')             # <<<<<<<<<<<<<<
 * 
 *                 if val_a == 0:
 */
          if (__Pyx_PrintOne(0, __pyx_kp_s_ERROR_Value_c_0) < 0) __PYX_ERR(0, 63, __pyx_L1_error)
 ...
 */
        ...
        /* "Markov_Models/analysis/src/_mle_tmat_prinz.pyx":65
 *                     print(r'ERROR! Value c > 0.')
 * 
 *                 if val_a == 0:             # <<<<<<<<<<<<<<
 *                     tmp = X[j,i]
 ...
 */
        ...
        if (__pyx_t_29) {
          ...
          /* "Markov_Models/analysis/src/_mle_tmat_prinz.pyx":66
 * 
 *                 if val_a == 0:
 *                     tmp = X[j,i]             # <<<<<<<<<<<<<<
 *                 else:
 ...
 */
          ...
          __pyx_v_tmp = (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_X.data + __pyx_t_98 * __pyx_v_X.strides[0]) ) + __pyx_t_99 * __pyx_v_X.strides[1]) )));
 ...
 */
        ...
        /* "Markov_Models/analysis/src/_mle_tmat_prinz.pyx":68
 *                     tmp = X[j,i]
 *                 else:
 *                     tmp = (-val_b + np.sqrt(val_b*val_b - 4*val_a*val_c)) / (2*val_a)             # <<<<<<<<<<<<<<
 * 
 ...
 */
        /*else*/ {
          __pyx_t_5 = PyFloat_FromDouble((-__pyx_v_val_b)); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 68, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_5);
          ...
          __Pyx_GOTREF(__pyx_t_2);
          __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
          __pyx_t_1 = PyFloat_FromDouble(((__pyx_v_val_b * __pyx_v_val_b) - ((4.0 * __pyx_v_val_a) * __pyx_v_val_c))); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 68, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_1);
          __pyx_t_65 = NULL;
          if (CYTHON_UNPACK_METHODS && unlikely(PyMethod_Check(__pyx_t_2))) {
            __pyx_t_65 = PyMethod_GET_SELF(__pyx_t_2);
          ...
          if (!__pyx_t_65) {
            __pyx_t_6 = __Pyx_PyObject_CallOneArg(__pyx_t_2, __pyx_t_1); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 68, __pyx_L1_error)
            __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
            __Pyx_GOTREF(__pyx_t_6);
          } else {
            #if CYTHON_FAST_PYCALL
            if (PyFunction_Check(__pyx_t_2)) {
              PyObject *__pyx_temp[2] = {__pyx_t_65, __pyx_t_1};
              __pyx_t_6 = __Pyx_PyFunction_FastCall(__pyx_t_2, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 68, __pyx_L1_error)
            ...
            if (__Pyx_PyFastCFunction_Check(__pyx_t_2)) {
              PyObject *__pyx_temp[2] = {__pyx_t_65, __pyx_t_1};
              __pyx_t_6 = __Pyx_PyCFunction_FastCall(__pyx_t_2, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 68, __pyx_L1_error)
              __Pyx_XDECREF(__pyx_t_65); __pyx_t_65 = 0;
              __Pyx_GOTREF(__pyx_t_6);
              __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
            } else
            #endif
            {
              ...
              __Pyx_GOTREF(__pyx_t_4);
              __Pyx_GIVEREF(__pyx_t_65); PyTuple_SET_ITEM(__pyx_t_4, 0, __pyx_t_65); __pyx_t_65 = NULL;
              __Pyx_GIVEREF(__pyx_t_1);
              PyTuple_SET_ITEM(__pyx_t_4, 0+1, __pyx_t_1);
              __pyx_t_1 = 0;
              __pyx_t_6 = __Pyx_PyObject_Call(__pyx_t_2, __pyx_t_4, NULL); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 68, __pyx_L1_error)
              __Pyx_GOTREF(__pyx_t_6);
              __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
            }
          }
          ...
          __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
          __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
          __pyx_t_6 = PyFloat_FromDouble((2.0 * __pyx_v_val_a)); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 68, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_6);
          __pyx_t_5 = __Pyx_PyNumber_Divide(__pyx_t_2, __pyx_t_6); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 68, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_5);
          __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
          __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
          __pyx_t_40 = __pyx_PyFloat_AsDouble(__pyx_t_5); if (unlikely((__pyx_t_40 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 68, __pyx_L1_error)
          __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
          __pyx_v_tmp = __pyx_t_40;
        }
        __pyx_L26:;

        /* "Markov_Models/analysis/src/_mle_tmat_prinz.pyx":70
 *                     tmp = (-val_b + np.sqrt(val_b*val_b - 4*val_a*val_c)) / (2*val_a)
 * 
 *                 xs[i] = xs[i] + (tmp - X[i,j])             # <<<<<<<<<<<<<<
 *                 xs[j] = xs[j] + (tmp - X[j,i])
 ...
 */
        ...
        *((double *) ( /* dim=0 */ (__pyx_v_xs.data + __pyx_t_103 * __pyx_v_xs.strides[0]) )) = ((*((double *) ( /* dim=0 */ (__pyx_v_xs.data + __pyx_t_100 * __pyx_v_xs.strides[0]) ))) + (__pyx_v_tmp - (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_X.data + __pyx_t_101 * __pyx_v_X.strides[0]) ) + __pyx_t_102 * __pyx_v_X.strides[1]) )))));

        /* "Markov_Models/analysis/src/_mle_tmat_prinz.pyx":71
 * 
 *                 xs[i] = xs[i] + (tmp - X[i,j])
 *                 xs[j] = xs[j] + (tmp - X[j,i])             # <<<<<<<<<<<<<<
 * 
 ...
 */
        ...
        *((double *) ( /* dim=0 */ (__pyx_v_xs.data + __pyx_t_107 * __pyx_v_xs.strides[0]) )) = ((*((double *) ( /* dim=0 */ (__pyx_v_xs.data + __pyx_t_104 * __pyx_v_xs.strides[0]) ))) + (__pyx_v_tmp - (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_X.data + __pyx_t_105 * __pyx_v_X.strides[0]) ) + __pyx_t_106 * __pyx_v_X.strides[1]) )))));

        /* "Markov_Models/analysis/src/_mle_tmat_prinz.pyx":73
 *                 xs[j] = xs[j] + (tmp - X[j,i])
 * 
 *                 X[i,j] = X[j,i] = tmp             # <<<<<<<<<<<<<<
 * 
 ...
 */
        ...
        *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_X.data + __pyx_t_108 * __pyx_v_X.strides[0]) ) + __pyx_t_109 * __pyx_v_X.strides[1]) )) = __pyx_v_tmp;
        __pyx_t_110 = __pyx_v_j;
        __pyx_t_111 = __pyx_v_i;
        *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_X.data + __pyx_t_110 * __pyx_v_X.strides[0]) ) + __pyx_t_111 * __pyx_v_X.strides[1]) )) = __pyx_v_tmp;

        /* "Markov_Models/analysis/src/_mle_tmat_prinz.pyx":75
 *                 X[i,j] = X[j,i] = tmp
 * 
 *                 xs[i] = 0             # <<<<<<<<<<<<<<
 ...
 */
        ...
        *((double *) ( /* dim=0 */ (__pyx_v_xs.data + __pyx_t_112 * __pyx_v_xs.strides[0]) )) = 0.0;

        /* "Markov_Models/analysis/src/_mle_tmat_prinz.pyx":76
 * 
 *                 xs[i] = 0
 *                 for k in range(nstates):             # <<<<<<<<<<<<<<
 *                     xs[i] = xs[i] + X[i,k]
 * 
 */
        __pyx_t_113 = __pyx_v_nstates;
        for (__pyx_t_114 = 0; __pyx_t_114 < __pyx_t_113; __pyx_t_114+=1) {
          __pyx_v_k = __pyx_t_114;

          /* "Markov_Models/analysis/src/_mle_tmat_prinz.pyx":77
 *                 xs[i] = 0
 *                 for k in range(nstates):
 *                     xs[i] = xs[i] + X[i,k]             # <<<<<<<<<<<<<<
 * 
 ...
 */
          ...
          *((double *) ( /* dim=0 */ (__pyx_v_xs.data + __pyx_t_118 * __pyx_v_xs.strides[0]) )) = ((*((double *) ( /* dim=0 */ (__pyx_v_xs.data + __pyx_t_115 * __pyx_v_xs.strides[0]) ))) + (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_X.data + __pyx_t_116 * __pyx_v_X.strides[0]) ) + __pyx_t_117 * __pyx_v_X.strides[1]) ))));
        }

        /* "Markov_Models/analysis/src/_mle_tmat_prinz.pyx":79
 *                     xs[i] = xs[i] + X[i,k]
 * 
 *                 xs[j] = 0             # <<<<<<<<<<<<<<
 *                 for k in range(nstates):
 ...
 */
        ...
        *((double *) ( /* dim=0 */ (__pyx_v_xs.data + __pyx_t_119 * __pyx_v_xs.strides[0]) )) = 0.0;

        /* "Markov_Models/analysis/src/_mle_tmat_prinz.pyx":80
 * 
 *                 xs[j] = 0
 *                 for k in range(nstates):             # <<<<<<<<<<<<<<
 *                     xs[j] = xs[j] + X[j,k]
 ...
 */
        ...
        for (__pyx_t_114 = 0; __pyx_t_114 < __pyx_t_113; __pyx_t_114+=1) {
          ...
          /* "Markov_Models/analysis/src/_mle_tmat_prinz.pyx":81
 *                 xs[j] = 0
 *                 for k in range(nstates):
 *                     xs[j] = xs[j] + X[j,k]             # <<<<<<<<<<<<<<
 * 
 ...
 */
          ...
          *((double *) ( /* dim=0 */ (__pyx_v_xs.data + __pyx_t_123 * __pyx_v_xs.strides[0]) )) = ((*((double *) ( /* dim=0 */ (__pyx_v_xs.data + __pyx_t_120 * __pyx_v_xs.strides[0]) ))) + (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_X.data + __pyx_t_121 * __pyx_v_X.strides[0]) ) + __pyx_t_122 * __pyx_v_X.strides[1]) ))));
        }

        /* "Markov_Models/analysis/src/_mle_tmat_prinz.pyx":83
 *                     xs[j] = xs[j] + X[j,k]
 * 
 *                 if X[i,j] > 0:             # <<<<<<<<<<<<<<
 ...
 */
        ...
        __pyx_t_29 = (((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_X.data + __pyx_t_124 * __pyx_v_X.strides[0]) ) + __pyx_t_125 * __pyx_v_X.strides[1]) ))) > 0.0) != 0);
        if (__pyx_t_29) {

          /* "Markov_Models/analysis/src/_mle_tmat_prinz.pyx":84
 * 
 *                 if X[i,j] > 0:
 *                     liklihood = liklihood + C[i,j]*np.log(X[i,j]/xs[i]) + C[j,i]*np.log(X[j,i]/xs[j])             # <<<<<<<<<<<<<<
 * 
 *     for i in range(nstates):
 */
          __pyx_t_5 = PyFloat_FromDouble(__pyx_v_liklihood); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 84, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_5);
          __pyx_t_126 = __pyx_v_i;
          __pyx_t_127 = __pyx_v_j;
          __pyx_t_6 = PyFloat_FromDouble((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_C.data + __pyx_t_126 * __pyx_v_C.strides[0]) ) + __pyx_t_127 * __pyx_v_C.strides[1]) )))); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 84, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_6);
          ...
          __pyx_t_40 = (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_X.data + __pyx_t_128 * __pyx_v_X.strides[0]) ) + __pyx_t_129 * __pyx_v_X.strides[1]) )));
          __pyx_t_130 = __pyx_v_i;
          __pyx_t_44 = (*((double *) ( /* dim=0 */ (__pyx_v_xs.data + __pyx_t_130 * __pyx_v_xs.strides[0]) )));
          if (unlikely(__pyx_t_44 == 0)) {
            PyErr_SetString(PyExc_ZeroDivisionError, "float division");
            __PYX_ERR(0, 84, __pyx_L1_error)
          }
          __pyx_t_4 = PyFloat_FromDouble((__pyx_t_40 / __pyx_t_44)); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 84, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_4);
          __pyx_t_65 = NULL;
          if (CYTHON_UNPACK_METHODS && unlikely(PyMethod_Check(__pyx_t_1))) {
            __pyx_t_65 = PyMethod_GET_SELF(__pyx_t_1);
            if (likely(__pyx_t_65)) {
          ...
          if (!__pyx_t_65) {
            ...
            if (PyFunction_Check(__pyx_t_1)) {
              PyObject *__pyx_temp[2] = {__pyx_t_65, __pyx_t_4};
              __pyx_t_2 = __Pyx_PyFunction_FastCall(__pyx_t_1, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 84, __pyx_L1_error)
              __Pyx_XDECREF(__pyx_t_65); __pyx_t_65 = 0;
              __Pyx_GOTREF(__pyx_t_2);
              __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
            } else
            ...
            if (__Pyx_PyFastCFunction_Check(__pyx_t_1)) {
              PyObject *__pyx_temp[2] = {__pyx_t_65, __pyx_t_4};
              __pyx_t_2 = __Pyx_PyCFunction_FastCall(__pyx_t_1, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 84, __pyx_L1_error)
              __Pyx_XDECREF(__pyx_t_65); __pyx_t_65 = 0;
              __Pyx_GOTREF(__pyx_t_2);
              __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
            } else
            #endif
            {
              ...
              __Pyx_GOTREF(__pyx_t_3);
              __Pyx_GIVEREF(__pyx_t_65); PyTuple_SET_ITEM(__pyx_t_3, 0, __pyx_t_65); __pyx_t_65 = NULL;
              __Pyx_GIVEREF(__pyx_t_4);
              PyTuple_SET_ITEM(__pyx_t_3, 0+1, __pyx_t_4);
              __pyx_t_4 = 0;
              __pyx_t_2 = __Pyx_PyObject_Call(__pyx_t_1, __pyx_t_3, NULL); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 84, __pyx_L1_error)
              __Pyx_GOTREF(__pyx_t_2);
              __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
            }
          }
          __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
          __pyx_t_1 = PyNumber_Multiply(__pyx_t_6, __pyx_t_2); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 84, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_1);
          __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
          __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
          __pyx_t_2 = PyNumber_Add(__pyx_t_5, __pyx_t_1); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 84, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_2);
          __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
          __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
          __pyx_t_131 = __pyx_v_j;
          __pyx_t_132 = __pyx_v_i;
          __pyx_t_1 = PyFloat_FromDouble((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_C.data + __pyx_t_131 * __pyx_v_C.strides[0]) ) + __pyx_t_132 * __pyx_v_C.strides[1]) )))); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 84, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_1);
          __pyx_t_6 = __Pyx_GetModuleGlobalName(__pyx_n_s_np); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 84, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_6);
          __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_6, __pyx_n_s_log); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 84, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_3);
          __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
          __pyx_t_133 = __pyx_v_j;
          __pyx_t_134 = __pyx_v_i;
          __pyx_t_44 = (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_X.data + __pyx_t_133 * __pyx_v_X.strides[0]) ) + __pyx_t_134 * __pyx_v_X.strides[1]) )));
          __pyx_t_135 = __pyx_v_j;
          __pyx_t_40 = (*((double *) ( /* dim=0 */ (__pyx_v_xs.data + __pyx_t_135 * __pyx_v_xs.strides[0]) )));
          if (unlikely(__pyx_t_40 == 0)) {
            PyErr_SetString(PyExc_ZeroDivisionError, "float division");
            __PYX_ERR(0, 84, __pyx_L1_error)
          }
          __pyx_t_6 = PyFloat_FromDouble((__pyx_t_44 / __pyx_t_40)); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 84, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_6);
          __pyx_t_4 = NULL;
          if (CYTHON_UNPACK_METHODS && unlikely(PyMethod_Check(__pyx_t_3))) {
            __pyx_t_4 = PyMethod_GET_SELF(__pyx_t_3);
          ...
          if (!__pyx_t_4) {
            __pyx_t_5 = __Pyx_PyObject_CallOneArg(__pyx_t_3, __pyx_t_6); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 84, __pyx_L1_error)
            __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
            __Pyx_GOTREF(__pyx_t_5);
          } else {
            #if CYTHON_FAST_PYCALL
            if (PyFunction_Check(__pyx_t_3)) {
              PyObject *__pyx_temp[2] = {__pyx_t_4, __pyx_t_6};
              __pyx_t_5 = __Pyx_PyFunction_FastCall(__pyx_t_3, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 84, __pyx_L1_error)
              __Pyx_XDECREF(__pyx_t_4); __pyx_t_4 = 0;
              __Pyx_GOTREF(__pyx_t_5);
              __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
            } else
            ...
            if (__Pyx_PyFastCFunction_Check(__pyx_t_3)) {
              PyObject *__pyx_temp[2] = {__pyx_t_4, __pyx_t_6};
              __pyx_t_5 = __Pyx_PyCFunction_FastCall(__pyx_t_3, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 84, __pyx_L1_error)
              __Pyx_XDECREF(__pyx_t_4); __pyx_t_4 = 0;
              __Pyx_GOTREF(__pyx_t_5);
              __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
            } else
            #endif
            {
              __pyx_t_65 = PyTuple_New(1+1); if (unlikely(!__pyx_t_65)) __PYX_ERR(0, 84, __pyx_L1_error)
              __Pyx_GOTREF(__pyx_t_65);
              __Pyx_GIVEREF(__pyx_t_4); PyTuple_SET_ITEM(__pyx_t_65, 0, __pyx_t_4); __pyx_t_4 = NULL;
              __Pyx_GIVEREF(__pyx_t_6);
              PyTuple_SET_ITEM(__pyx_t_65, 0+1, __pyx_t_6);
              __pyx_t_6 = 0;
              __pyx_t_5 = __Pyx_PyObject_Call(__pyx_t_3, __pyx_t_65, NULL); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 84, __pyx_L1_error)
              __Pyx_GOTREF(__pyx_t_5);
              __Pyx_DECREF(__pyx_t_65); __pyx_t_65 = 0;
            }
          }
          __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
          __pyx_t_3 = PyNumber_Multiply(__pyx_t_1, __pyx_t_5); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 84, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_3);
          __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
          __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
          __pyx_t_5 = PyNumber_Add(__pyx_t_2, __pyx_t_3); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 84, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_5);
          __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
          __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
          __pyx_t_40 = __pyx_PyFloat_AsDouble(__pyx_t_5); if (unlikely((__pyx_t_40 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 84, __pyx_L1_error)
          __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
          __pyx_v_liklihood = __pyx_t_40;
 ...
 */
  ...
  /* "Markov_Models/analysis/src/_mle_tmat_prinz.pyx":86
 *                     liklihood = liklihood + C[i,j]*np.log(X[i,j]/xs[i]) + C[j,i]*np.log(X[j,i]/xs[j])
 * 
 *     for i in range(nstates):             # <<<<<<<<<<<<<<
 *         for j in range(nstates):
 ...
 */
  ...
  for (__pyx_t_10 = 0; __pyx_t_10 < __pyx_t_9; __pyx_t_10+=1) {
    ...
    /* "Markov_Models/analysis/src/_mle_tmat_prinz.pyx":87
 * 
 *     for i in range(nstates):
 *         for j in range(nstates):             # <<<<<<<<<<<<<<
 *             T[i,j] = X[i,j]/xs[i]
 ...
 */
    ...
    for (__pyx_t_12 = 0; __pyx_t_12 < __pyx_t_11; __pyx_t_12+=1) {
      ...
      /* "Markov_Models/analysis/src/_mle_tmat_prinz.pyx":88
 *     for i in range(nstates):
 *         for j in range(nstates):
 *             T[i,j] = X[i,j]/xs[i]             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      __pyx_t_40 = (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_X.data + __pyx_t_136 * __pyx_v_X.strides[0]) ) + __pyx_t_137 * __pyx_v_X.strides[1]) )));
      __pyx_t_138 = __pyx_v_i;
      __pyx_t_44 = (*((double *) ( /* dim=0 */ (__pyx_v_xs.data + __pyx_t_138 * __pyx_v_xs.strides[0]) )));
      if (unlikely(__pyx_t_44 == 0)) {
        PyErr_SetString(PyExc_ZeroDivisionError, "float division");
      ...
      *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_T.data + __pyx_t_139 * __pyx_v_T.strides[0]) ) + __pyx_t_140 * __pyx_v_T.strides[1]) )) = (__pyx_t_40 / __pyx_t_44);
    }
  }

  /* "Markov_Models/analysis/src/_mle_tmat_prinz.pyx":90
 *             T[i,j] = X[i,j]/xs[i]
 * 
 *     return T             # <<<<<<<<<<<<<<
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_5 = __pyx_memoryview_fromslice(__pyx_v_T, 2, (PyObject *(*)(char *)) __pyx_memview_get_double, (int (*)(char *, PyObject *)) __pyx_memview_set_double, 0);; if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 90, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_r = __pyx_t_5;
  __pyx_t_5 = 0;
  goto __pyx_L0;
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "Markov_Models.analysis.src._mle_tmat_prinz.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "Markov_Models.analysis.src._mle_tmat_prinz.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "Markov_Models.analysis.src._mle_tmat_prinz.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "Markov_Models.analysis.src._mle_tmat_prinz._memoryviewslice", /*tp_name*/
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_Markov_Models_analysis_src__mle, __pyx_k_Markov_Models_analysis_src__mle, sizeof(__pyx_k_Markov_Models_analysis_src__mle), 0, 0, 1, 1},
  ...
  {&__pyx_kp_s_Users_pablo_Programs_Markov_Mod, __pyx_k_Users_pablo_Programs_Markov_Mod, sizeof(__pyx_k_Users_pablo_Programs_Markov_Mod), 0, 0, 1, 0},
 ...
 *     cdef double[:,:] T = np.zeros((nstates, nstates)).astype(np.float64)
 */
  __pyx_tuple__23 = PyTuple_Pack(18, __pyx_n_s_C, __pyx_n_s_tol, __pyx_n_s_max_iteration, __pyx_n_s_nstates, __pyx_n_s_T, __pyx_n_s_X, __pyx_n_s_xs, __pyx_n_s_cs, __pyx_n_s_liklihood, __pyx_n_s_liklihood_prev, __pyx_n_s_i, __pyx_n_s_j, __pyx_n_s_k, __pyx_n_s_iteration, __pyx_n_s_val_a, __pyx_n_s_val_b, __pyx_n_s_val_c, __pyx_n_s_tmp); if (unlikely(!__pyx_tuple__23)) __PYX_ERR(0, 8, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__23);
  __Pyx_GIVEREF(__pyx_tuple__23);
  __pyx_codeobj__24 = (PyObject*)__Pyx_PyCode_New(3, 0, 18, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__23, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_Users_pablo_Programs_Markov_Mod, __pyx_n_s_transition_matrix, 8, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__24)) __PYX_ERR(0, 8, __pyx_L1_error)
...
#endif
{
  ...
  #endif
  if (__pyx_module_is_main_Markov_Models__analysis__src___mle_tmat_prinz) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "Markov_Models.analysis.src._mle_tmat_prinz")) {
      if (unlikely(PyDict_SetItemString(modules, "Markov_Models.analysis.src._mle_tmat_prinz", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "Markov_Models/analysis/src/_mle_tmat_prinz.pyx":2
 ...
 *     cdef double[:,:] T = np.zeros((nstates, nstates)).astype(np.float64)
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_13Markov_Models_8analysis_3src_15_mle_tmat_prinz_1transition_matrix, NULL, __pyx_n_s_Markov_Models_analysis_src__mle); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 8, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_transition_matrix, __pyx_t_1) < 0) __PYX_ERR(0, 8, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "Markov_Models/analysis/src/_mle_tmat_prinz.pyx":1
 * from __future__ import division             # <<<<<<<<<<<<<<
 * import numpy as np
 * cimport numpy as np
 */
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init Markov_Models.analysis.src._mle_tmat_prinz", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init Markov_Models.analysis.src._mle_tmat_prinz");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
